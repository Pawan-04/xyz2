...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#050505] text-[#f8fafc] flex items-center justify-center pt-20 overflow-hidden">
      
      {/* Background Architectural Grid Effect */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:40px_40px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]" />

      <div className="relative z-10 w-full max-w-6xl px-4 sm:px-8 flex flex-col md:flex-row items-center gap-8 md:gap-16">
        ...
        >
          ...
          <div className="relative w-56 h-56 sm:w-64 sm:h-64 md:w-80 md:h-96 rounded-3xl overflow-hidden border border-white/10 bg-[#0a0a0a]">
            <img 
              src={profile}
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          >
            <h2 className="text-blue-500 font-mono text-xs tracking-[0.4em] uppercase mb-6">// Full-Stack Architect</h2>
             ...
             <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-none mb-8">
              Building <br />
              <span className="text-gray-500 italic font-serif">intelligent App.</span>
            </h1>

            <p className="max-w-xl text-slate-300 text-lg font-light leading-relaxed mb-10">
 I build full-stack web applications using the <span className="text-white font-medium">MERN stack</span> and explore adding <span className="text-white font-medium">AI features</span> to make them more useful.
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-x-3 gap-y-2 mb-12">
              {skills.map((skill) => (
                <span 
                  key={skill} 
                  className="px-3 py-2 bg-white/[0.03] border border-white/10 text-slate-300 text-[10px] font-bold uppercase tracking-widest rounded-lg hover:border-blue-500/50 hover:text-white transition-all cursor-default"
                >
                  {skill}
                </span>
              ))}
            ...
            {/* ACTION ROW */}
            <div className="flex flex-wrap justify-center md:justify-start items-center gap-6 sm:gap-8">
              ...
              <div className="flex items-center gap-6 text-gray-500 md:border-l md:border-white/10 md:pl-8">
